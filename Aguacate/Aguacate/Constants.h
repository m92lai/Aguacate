...
#define BACKGROUND_COLOR [UIColor colorWithRed:240.0f/255.0f green:240.0f/255.0f blue:240.0f/255.0f alpha:1]
#define BOARD_SIZE [[UIScreen mainScreen] bounds].size.width - (BOARD_PADDING * 2)
...
extern int const BOARD_PADDING;
